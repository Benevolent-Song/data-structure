...
public class Day2单链表 {
    ...
    class nodemanage2//链表结构,用于多个节点的管理
    {
        private node1 head=new node1(0,"","");//私有头指针,不能贝改变
        node1 temp=head;
        public void add(node1 node1)//将节点添加到链表的最后位置
        {
            while (true)
            {
                if(temp.next==null)
